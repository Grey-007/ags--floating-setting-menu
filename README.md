...
✅ **Modern imports** - `import { Widget } from "ags"`
✅ **Pre-compiled CSS** - No runtime SCSS compilation
✅ **snake_case properties** - `class_name`, `on_clicked`
✅ **TypeScript support** - .ts files (works with .js too)
✅ **Modular design** - Easy to add bars, launchers, etc.
...
│   └── style.css               ← Compiled (generated by build.sh)
└── widgets/
    └── refreshMenu/
        ├── window.ts           ← Main window (self-registers)
        ├── components/
        │   └── section.ts      ← Reusable section
        ├── sections/
        │   ├── refreshApps.ts  ← Refresh apps section
        │   └── comingSoon.ts   ← Placeholder sections
        └── utils/
...
import "./widgets/bar/window.js";  // ← Add this line
```
...
✅ Modern AGS v3 API only
✅ Self-registering windows
✅ TypeScript support
✅ Pre-compiled styles
✅ Smooth GTK animations
...
**Ready to use!** This is the modern way to build AGS configs. 🚀
